...
class JobOpportunity(SoftDeleteModel):
    ...
    request_number = models.CharField(max_length=50, db_index=True, null=True, blank=True, verbose_name="شماره درخواست")
    ...
    FACTORY_CHOICES = [
        ...
        ('مجتمع فولاد و نورد سبا', 'مجتمع فولاد و نورد سبا'),
        ('فولاد هرمزگان', 'فولاد هرمزگان'),
        ('فولاد امیرکبیر', 'فولاد امیرکبیر'),
        ('فولاد سفیددشت', 'فولاد سفیددشت'),
